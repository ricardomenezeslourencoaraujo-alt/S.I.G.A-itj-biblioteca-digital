...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var langItems = document.querySelectorAll(".language-list li");
  var loginForm = document.getElementById("form-login");
  var regForm = document.getElementById("form-register");
  var errorMessage = document.querySelector(".error-message");
  var regErrorMessage = document.querySelector(".reg-error-message");
  ...
  var regConfirmPassword = document.getElementById("reg-confirm-password");
  var loginEmail = document.getElementById("login-email");
  var loginPassword = document.getElementById("login-password");
  var capsWarningReg = document.getElementById("caps_warning_reg");
  var capsWarningLogin = document.getElementById("caps_warning");
  ...
  function showMessage(element, isSuccess) {
    var isMatchError = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var t = translations[idiomaAtual];
    ...
    element.style.border = "1px solid ".concat(isSuccess ? "#16a34a" : "#dc2626");
  ...
  langItems.forEach(function (item) {
    item.addEventListener("click", function () {
      ...
      idiomaAtual = lang;
      var t = translations[lang]; // Atualiza bandeira e texto do seletor

      document.getElementById("current-lang-text").textContent = lang.toUpperCase();
      document.getElementById("current-flag").src = t.flag; // Títulos e placeholders
      ...
      capsWarningLogin.textContent = t.msgCaps; // Painéis laterais
      ...
      document.getElementById("register").textContent = t.btnPanelRight; // Botão Google (ícone + texto traduzido)

      if (googleBtn) {
        googleBtn.innerHTML = "<i class=\"fab fa-google\"></i> ".concat(t.googleBtn);
      }
  ...
  regForm.addEventListener("submit", function (e) {
    ...
    var btn = document.getElementById("btn-submit-register");
    btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i>';
    setTimeout(function () {
...
//# sourceMappingURL=login_user.dev.js.map
